package edu.jnu.test.types.rule02.factory;


import edu.jnu.test.types.rule02.logic.RuleLogic201;
import edu.jnu.test.types.rule02.logic.RuleLogic202;
import edu.jnu.test.types.rule02.logic.XxxResponse;
