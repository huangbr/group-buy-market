package edu.jnu.test.domain.trade;
...
public class ITradeLockOrderServiceTest {
    ...
    public void test_lockMarketPayOrder() throws Exception {
        ...
        MarketPayOrderEntity marketPayOrderEntityOld = tradeOrderService.queryUnPayMarketPayOrderByOutTradeNo(userId, outTradeNo);
